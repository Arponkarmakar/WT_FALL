...
<td><input  name="address" placeholder="enter address"  id="address"  onekeyup="checkaddress()"></td>
...
<td><input type="text" name="passport" placeholder="enter passport number" id="passport"    onekeyup="checkpassport()"></td>
<td><?php echo $passportError;?><p id="errorpassport"></p></td>
</tr>

<tr>
<td><lable for="mobilenumber">MOBILE NUMBER:- </lable></td>   
<td><input type="text" name="mobilenumber" placeholder="enter number" id="mobile"  onekeyup="checkmobile()"></td>
