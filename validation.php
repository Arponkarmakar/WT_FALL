...
<td><input type="checkbox" name="ssc" >SSC<input type="text" name="ssc" placeholder="enter cgpa"></br> 
<input type="checkbox" name="hsc" >HSC <input type="text" name="hsc" placeholder="enter cgpa"></br> 
<input type="checkbox" name="bsc" >BSC<input type="text" name="bsc" placeholder="enter cgpa"></br> 
<input type="checkbox" name="msc" >MSC<input type="text" name="msc" placeholder="enter cgpa"></br> </td>
</tr>
